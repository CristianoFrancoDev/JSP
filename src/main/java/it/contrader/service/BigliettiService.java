...
public class BigliettiService extends AbstractService<Biglietto, BigliettoDTO>
{
    ...
    {
        return dao.update(converter.toEntity(bigliettoDTO));
    }
    ...
    public List<BigliettoDTO> filterByPista(PistaDTO pistaDTO, UtenteDTO utenteDTO)
    {
        ...
        bigliettoList = ((Dao_Biglietti)dao).filterByPista(PistaConverter.getInstance().toEntity(pistaDTO),UtenteConverter.getInstance().toEntity(utenteDTO));
    ...
    public List<BigliettoDTO> filterByDate(UtenteDTO utenteDTO, LocalDate from, LocalDate to)
    {
        ...
        ArrayList<Biglietto> biglietti = ((Dao_Biglietti)dao).filterBigliettiByData(utente, from, to);
