...
public class Dao_Piste implements DAO<Pista>
{
    ...
    {
        ImpiantiService impiantiService = ImpiantiService.getInstance();
        ...
        if (connection != null)
        {
            try
            {
                ...
                if (resultSet.next())
                {
                    impianto = impiantoConverter.toEntity(impiantiService.read(resultSet.getInt(3)));
        ...
        try
        {
            ...
            while (resultSet.next())
            {
                 response.add(new Pista(resultSet.getInt(1),
                        resultSet.getString(2),
                        impiantoConverter.toEntity(impiantiService.read(resultSet.getInt(3)))));
            }
