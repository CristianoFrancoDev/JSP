...
public class Dao_Noleggi implements DAO<Noleggio>
{
    ...
    {
        AttrezzatureService attrezzatureService = AttrezzatureService.getInstance();
                ...
                if (resultSet.next())
                    {
                        response = new Noleggio(resultSet.getInt(1),
                            attrezzaturaConverter.toEntity(attrezzatureService.read(resultSet.getInt(2))),
                            bigliettoConverter.toEntity(bigliettiService.read(resultSet.getInt(3))));
                    }
        ...
        try
        {
            ...
            if (resultSet.next())
                response = new Biglietto(resultSet.getInt(1),
                        utenteConverter.toEntity(utentiService.read(resultSet.getInt(2))),
                        pistaConverter.toEntity(pisteService.read(resultSet.getInt(3))),
